<?php
/**
 * Модуль работы с базой данных. Управляет подключением, авторизацией, созданием лобби,
 * начислением очков, модерацией чата и билетами авторизации WebSocket.
 */

require_once __DIR__ . '/../config.php';

/**
 * Инициализирует и возвращает безопасное соединение с базой данных MySQL.
 * @return PDO
 */
function getPDO()
{
...
// ========== ФУНКЦИИ ГЕНЕРАЦИИ И ПРОВЕРКИ CSRF-ТОКЕНОВ БЕЗОПАСНОСТИ ==========
// Они защищают формы на сайте от отправки злоумышленниками с других ресурсов.
...
/**
 * Очищает лобби, которые были неактивны более 2 часов (стирает их вместе с чатом и вопросами).
...
/**
 * Модерирует сообщения чата и никнеймы, скрывая нецензурную лексику звёздочками.
...
/**
 * Проверяет, запущен ли в данный момент WebSocket-сервер для мгновенного обмена сообщениями.
 */
